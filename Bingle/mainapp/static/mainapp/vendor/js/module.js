        ...
        var t = function(t, e, s, i) {
            ...
            for (var h = 0; h < o; h++)
                for (var u = t[h], p = 0; p < r; p++) {
                    var f = e[p];
                    s[h] || i[p] || !x(u, f, d, c) ? l[h + 1][p + 1] = 0 : (l[h + 1][p + 1] = l[h][p] ? l[h][p] + 1 : 1,
...
var L = {
  ...
  , H = function() {
    function t(t, e, s) {
        this.options = s,
        this.t1 = "undefined" != typeof Element && u(t, "Element") ? k(t, this.options) : "string" == typeof t ? R(t, this.options) : JSON.parse(JSON.stringify(t)),
        this.t2 = "undefined" != typeof Element && u(e, "Element") ? k(e, this.options) : "string" == typeof e ? R(e, this.options) : JSON.parse(JSON.stringify(e)),
        this.diffcount = 0,
        this.foundAll = !1,
        this.debug && (this.t1Orig = "undefined" != typeof Element && u(t, "Element") ? k(t, this.options) : "string" == typeof t ? R(t, this.options) : JSON.parse(JSON.stringify(t)),
        this.t2Orig = "undefined" != typeof Element && u(e, "Element") ? k(e, this.options) : "string" == typeof e ? R(e, this.options) : JSON.parse(JSON.stringify(e))),
        this.tracker = new V
    }
    ...
    t.prototype.findDiffs = function(t, e) {
        ...
        do {
            ...
            0 === (s = this.findNextDiff(t, e, [])).length && (M(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0,
            N(t),
    ...
    t.prototype.findInnerDiff = function(t, e, s) {
        ...
        for (var u = 0; u < a; u += 1) {
            ...
            u -= 1,
            l -= 1,
            o -= 1) : i.length < n.length ? (r = r.concat([(new h).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.element, D(f)).setValue(this.options._const.route, s.concat(l))]),
            i.splice(u, 0, D(f)),
            o -= 1) : r = r.concat([(new h).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, D(p)).setValue(this.options._const.newValue, D(f)).setValue(this.options._const.route, s.concat(l))]))),
            l += 1
        }
            ...
            if (!n || !0 !== u[v] && !0 !== p[v]) {
                if (!0 === u[w])
                    if ("#text" === (l = f[w]).nodeName)
                        ...
                        !0 === p[v] ? b.push((new h).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, D(l)).setValue(this.options._const.newValue, D(m[v])).setValue(this.options._const.route, i.concat(w))) : (b.push((new h).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, D(l))),
                        u.splice(w, 1),
                        f.splice(w, 1),
                        g = Math.min(u.length, p.length),
                        w -= 1,
                    ...
                    g = Math.min(u.length, p.length)) : (b.push((new h).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, D(l))),
                    u.splice(w, 0, !0),
                    f.splice(w, 0, D(l)),
                    g = Math.min(u.length, p.length));
                else if (u[w] !== p[v]) {
                    ...
                    (o = Math.min(r.newValue, f.length - r.length)) !== r.oldValue) {
                        ...
                        for (var y = 0; y < r.length; y += 1)
                            x(f[o + y], f[r.oldValue + y], {}, !1, !0) || (a = !0);
                        if (a)
  ...
  , z = F(B.exports = function() {
    ...
    var O = function() {
        ...
        b.diff = function(i, u, p) {
            var f, m = this, g = x.p(u), b = M(i), v = (b.utcOffset() - this.utcOffset()) * e, w = this - b, _ = function() {
                return x.m(m, b)
            };
            switch (g) {
            case h:
...
export {it as DataTable, mt as addColumnFilter, nt as convertCSV, at as convertJSON, s as createElement, ot as exportCSV, rt as exportJSON, lt as exportSQL, dt as exportTXT, e as isJson, t as isObject, ut as makeEditable};
