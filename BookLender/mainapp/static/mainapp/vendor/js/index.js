...
var w = (n, u, f) => (ue(n, u, "read from private field"), f ? f.call(n) : u.get(n)),
    b = (n, u, f) => {
        if (u.has(n)) throw TypeError("Cannot add the same private member more than once");
        u instanceof WeakSet ? u.add(n) : u.set(n, f)
    },
    W = (n, u, f, j) => (ue(n, u, "write to private field"), j ? j.call(n, f) : u.set(n, f), f);
var v = (n, u, f) => (ue(n, u, "access private method"), f);
(function (n, u) {
    ...
    var k, A, I, pe, T, ge, R, ye, C, E, J, M, fe, V;
    "use strict";
    const u = "14.0";
    ...
    async function j(i, e = {}) {
        const {
            ...
            cdnUrl: s,
            ...r
        } = e, a = f(i, o, s), c = t ? localStorage : sessionStorage, h = `emojibase/${o}/${i}`, p = c.getItem(h);
    ...
    async function ve(i, e, t) {
        var o;
        return j(`${i}/shortcodes/${(o=Xe[e])!==null&&o!==void 0?o:e}.json`, t)
    }
    ...
    async function we(i, e = {}) {
        const {
            ...
            shortcodes: s = [],
            ...r
        } = e, a = await j(`${i}/${t?"compact":"data"}.json`, r);
        let c = [];
        return s.length > 0 && (c = await Promise.all(s.map(h => {
            let p;
            if (h.includes("/")) {
                const [m, d] = h.split("/");
                p = ve(m, d, r)
    ...
    function S(i, e, t, o) {
        ...
        const s = t.direction === "normal" ? 1 : 0,
            r = Object.entries(e).reduce((a, [c, h]) => ({
                ...a,
                [c]: h[s]
            }), {});
    ...
    function z(i) {
        ...
        return {
            ...
            label: i.label,
            tags: i.tags,
            skins: (e = i.skins) == null ? void 0 : e.map(t => z(t)),
            order: i.order,
            custom: !1,
            hexcode: i.hexcode,
            version: i.version
    ...
    function N(i, e, t) {
        var o;
        return t && !t.some(s => s.order === i.group) ? !1 : Q(i.label, e) || ((o = i.tags) == null ? void 0 : o.some(s => Q(s, e)))
    }
    class Pe {
        constructor(e = "en") {
            this.locale = e
    ...
    const tt = [(i, e) => (i.hexcode === "1F91D" && e < 14 && (i.skins = []), i), (i, e) => (i.skins && (i.skins = i.skins.filter(t => !t.version || t.version <= e)), i)];

    function it(i, e) {
        return tt.some(t => t(i, e) === null) ? null : i
    }

    function H(i, e) {
        return i.filter(t => it(t, e) !== null)
    }
    const X = {};

    function Z(i) {
        return X[i] || (X[i] = new ot(i)), X[i]
    }
    Z.deleteDatabase = i => {};
    class ot extends Pe {
        open() {
        ...
        getEmojis(e, t) {
            const o = this.emojis.filter(s => s.group === e.order).filter(s => s.version <= t).sort((s, r) => s.order != null && r.order != null ? s.order - r.order : 0).map(z);
            return Promise.resolve(H(o, t))
        }
        searchEmojis(e, t, o, s) {
            const r = this.emojis.filter(h => N(h, e, s) && h.version <= o).map(z),
                a = t.filter(h => N(h, e, s)),
                c = [...H(r, o), ...a];
    ...
    Ee() || (console.warn("[picmo] sessionStorage not available, falling back to simple in-memory storage"), Object.defineProperty(window, "sessionStorage", {
        value: Se()
    }));
    ...
    async function at(i, e, t) {
        ...
        if (t !== r || e !== s) {
            const [a, c] = await Promise.all([be(i.locale), we(i.locale)]);
            await i.populate({
                groups: a.groups,
                emojis: c,
                emojisEtag: e,
    ...
    async function Le(i, e, t) {
        ...
        try {
            ...
            console.warn("[picmo] IndexedDB not available, falling back to InMemoryStoreFactory"), o = Z(i)
        }
        return o
    }
    async function ct(i, e, t) {
        const o = await Le(i, e, t),
            [s, r] = await rt(i);
        if (await o.isPopulated()) s && r && await at(o, s, r);
        else {
            const [a, c] = await Promise.all([be(i), we(i)]);
            await o.populate({
                groups: a.groups,
                emojis: c,
                emojisEtag: s,
    ...
    async function lt(i, e, t, o, s) {
        const r = await Le(i, e, s),
            a = await je(o);
        return (!await r.isPopulated() || await nt(r, a)) && await r.populate({
            groups: t.groups,
            emojis: o,
            hash: a
        }), r
    }
    async function ee(i, e, t, o, s) {
        return t && o ? lt(i, e, t, o, s) : ct(i, e, s)
    }
        ...
        scheduleShowAnimation() {
            if (this.parent) {
                const e = new MutationObserver(t => {
                    const [o] = t;
                    o.type === "childList" && o.addedNodes[0] === this.el && (Y(this.options) && this.animateShow && this.animateShow(), e.disconnect)
                });
    ...
    const ut = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512zM232 256C232 264 236 271.5 242.7 275.1L338.7 339.1C349.7 347.3 364.6 344.3 371.1 333.3C379.3 322.3 376.3 307.4 365.3 300L280 243.2V120C280 106.7 269.3 96 255.1 96C242.7 96 231.1 106.7 231.1 120L232 256z"/></svg>',
        pt = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M64 496C64 504.8 56.75 512 48 512h-32C7.25 512 0 504.8 0 496V32c0-17.75 14.25-32 32-32s32 14.25 32 32V496zM476.3 0c-6.365 0-13.01 1.35-19.34 4.233c-45.69 20.86-79.56 27.94-107.8 27.94c-59.96 0-94.81-31.86-163.9-31.87C160.9 .3055 131.6 4.867 96 15.75v350.5c32-9.984 59.87-14.1 84.85-14.1c73.63 0 124.9 31.78 198.6 31.78c31.91 0 68.02-5.971 111.1-23.09C504.1 355.9 512 344.4 512 332.1V30.73C512 11.1 495.3 0 476.3 0z"/></svg>',
        gt = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256zM176.4 240C194 240 208.4 225.7 208.4 208C208.4 190.3 194 176 176.4 176C158.7 176 144.4 190.3 144.4 208C144.4 225.7 158.7 240 176.4 240zM336.4 176C318.7 176 304.4 190.3 304.4 208C304.4 225.7 318.7 240 336.4 240C354 240 368.4 225.7 368.4 208C368.4 190.3 354 176 336.4 176zM259.9 369.4C288.8 369.4 316.2 375.2 340.6 385.5C352.9 390.7 366.7 381.3 361.4 369.1C344.8 330.9 305.6 303.1 259.9 303.1C214.3 303.1 175.1 330.8 158.4 369.1C153.1 381.3 166.1 390.6 179.3 385.4C203.7 375.1 231 369.4 259.9 369.4L259.9 369.4z"/></svg>',
        yt = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M448 64H192C85.96 64 0 149.1 0 256s85.96 192 192 192h256c106 0 192-85.96 192-192S554 64 448 64zM247.1 280h-32v32c0 13.2-10.78 24-23.98 24c-13.2 0-24.02-10.8-24.02-24v-32L136 279.1C122.8 279.1 111.1 269.2 111.1 256c0-13.2 10.85-24.01 24.05-24.01L167.1 232v-32c0-13.2 10.82-24 24.02-24c13.2 0 23.98 10.8 23.98 24v32h32c13.2 0 24.02 10.8 24.02 24C271.1 269.2 261.2 280 247.1 280zM431.1 344c-22.12 0-39.1-17.87-39.1-39.1s17.87-40 39.1-40s39.1 17.88 39.1 40S454.1 344 431.1 344zM495.1 248c-22.12 0-39.1-17.87-39.1-39.1s17.87-40 39.1-40c22.12 0 39.1 17.88 39.1 40S518.1 248 495.1 248z"/></svg>',
        ft = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M112.1 454.3c0 6.297 1.816 12.44 5.284 17.69l17.14 25.69c5.25 7.875 17.17 14.28 26.64 14.28h61.67c9.438 0 21.36-6.401 26.61-14.28l17.08-25.68c2.938-4.438 5.348-12.37 5.348-17.7L272 415.1h-160L112.1 454.3zM191.4 .0132C89.44 .3257 16 82.97 16 175.1c0 44.38 16.44 84.84 43.56 115.8c16.53 18.84 42.34 58.23 52.22 91.45c.0313 .25 .0938 .5166 .125 .7823h160.2c.0313-.2656 .0938-.5166 .125-.7823c9.875-33.22 35.69-72.61 52.22-91.45C351.6 260.8 368 220.4 368 175.1C368 78.61 288.9-.2837 191.4 .0132zM192 96.01c-44.13 0-80 35.89-80 79.1C112 184.8 104.8 192 96 192S80 184.8 80 176c0-61.76 50.25-111.1 112-111.1c8.844 0 16 7.159 16 16S200.8 96.01 192 96.01z"/></svg>',
        vt = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M512 32H120c-13.25 0-24 10.75-24 24L96.01 288c0 53 43 96 96 96h192C437 384 480 341 480 288h32c70.63 0 128-57.38 128-128S582.6 32 512 32zM512 224h-32V96h32c35.25 0 64 28.75 64 64S547.3 224 512 224zM560 416h-544C7.164 416 0 423.2 0 432C0 458.5 21.49 480 48 480h480c26.51 0 48-21.49 48-48C576 423.2 568.8 416 560 416z"/></svg>',
        wt = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M482.3 192C516.5 192 576 221 576 256C576 292 516.5 320 482.3 320H365.7L265.2 495.9C259.5 505.8 248.9 512 237.4 512H181.2C170.6 512 162.9 501.8 165.8 491.6L214.9 320H112L68.8 377.6C65.78 381.6 61.04 384 56 384H14.03C6.284 384 0 377.7 0 369.1C0 368.7 .1818 367.4 .5398 366.1L32 256L.5398 145.9C.1818 144.6 0 143.3 0 142C0 134.3 6.284 128 14.03 128H56C61.04 128 65.78 130.4 68.8 134.4L112 192H214.9L165.8 20.4C162.9 10.17 170.6 0 181.2 0H237.4C248.9 0 259.5 6.153 265.2 16.12L365.7 192H482.3z"/></svg>',
        ...
        Ct = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  <defs>
  ...
  <path fill="url(#gradient-0)" d="M256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0zM256 352C290.9 352 323.2 367.8 348.3 394.9C354.3 401.4 364.4 401.7 370.9 395.7C377.4 389.7 377.7 379.6 371.7 373.1C341.6 340.5 301 320 256 320C247.2 320 240 327.2 240 336C240 344.8 247.2 352 256 352H256zM208 369C208 349 179.6 308.6 166.4 291.3C163.2 286.9 156.8 286.9 153.6 291.3C140.6 308.6 112 349 112 369C112 395 133.5 416 160 416C186.5 416 208 395 208 369H208zM303.6 208C303.6 225.7 317.1 240 335.6 240C353.3 240 367.6 225.7 367.6 208C367.6 190.3 353.3 176 335.6 176C317.1 176 303.6 190.3 303.6 208zM207.6 208C207.6 190.3 193.3 176 175.6 176C157.1 176 143.6 190.3 143.6 208C143.6 225.7 157.1 240 175.6 240C193.3 240 207.6 225.7 207.6 208z" />
        ...
        _t = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M500.3 443.7l-119.7-119.7c27.22-40.41 40.65-90.9 33.46-144.7C401.8 87.79 326.8 13.32 235.2 1.723C99.01-15.51-15.51 99.01 1.724 235.2c11.6 91.64 86.08 166.7 177.6 178.9c53.8 7.189 104.3-6.236 144.7-33.46l119.7 119.7c15.62 15.62 40.95 15.62 56.57 0C515.9 484.7 515.9 459.3 500.3 443.7zM79.1 208c0-70.58 57.42-128 128-128s128 57.42 128 128c0 70.58-57.42 128-128 128S79.1 278.6 79.1 208z"/></svg>',
        jt = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256zM256.3 331.8C208.9 331.8 164.1 324.9 124.5 312.8C112.2 309 100.2 319.7 105.2 331.5C130.1 390.6 188.4 432 256.3 432C324.2 432 382.4 390.6 407.4 331.5C412.4 319.7 400.4 309 388.1 312.8C348.4 324.9 303.7 331.8 256.3 331.8H256.3zM176.4 176C158.7 176 144.4 190.3 144.4 208C144.4 225.7 158.7 240 176.4 240C194 240 208.4 225.7 208.4 208C208.4 190.3 194 176 176.4 176zM336.4 240C354 240 368.4 225.7 368.4 208C368.4 190.3 354 176 336.4 176C318.7 176 304.4 190.3 304.4 208C304.4 225.7 318.7 240 336.4 240z"/></svg>',
        kt = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M500.3 7.251C507.7 13.33 512 22.41 512 31.1V175.1C512 202.5 483.3 223.1 447.1 223.1C412.7 223.1 383.1 202.5 383.1 175.1C383.1 149.5 412.7 127.1 447.1 127.1V71.03L351.1 90.23V207.1C351.1 234.5 323.3 255.1 287.1 255.1C252.7 255.1 223.1 234.5 223.1 207.1C223.1 181.5 252.7 159.1 287.1 159.1V63.1C287.1 48.74 298.8 35.61 313.7 32.62L473.7 .6198C483.1-1.261 492.9 1.173 500.3 7.251H500.3zM74.66 303.1L86.5 286.2C92.43 277.3 102.4 271.1 113.1 271.1H174.9C185.6 271.1 195.6 277.3 201.5 286.2L213.3 303.1H239.1C266.5 303.1 287.1 325.5 287.1 351.1V463.1C287.1 490.5 266.5 511.1 239.1 511.1H47.1C21.49 511.1-.0019 490.5-.0019 463.1V351.1C-.0019 325.5 21.49 303.1 47.1 303.1H74.66zM143.1 359.1C117.5 359.1 95.1 381.5 95.1 407.1C95.1 434.5 117.5 455.1 143.1 455.1C170.5 455.1 191.1 434.5 191.1 407.1C191.1 381.5 170.5 359.1 143.1 359.1zM440.3 367.1H496C502.7 367.1 508.6 372.1 510.1 378.4C513.3 384.6 511.6 391.7 506.5 396L378.5 508C372.9 512.1 364.6 513.3 358.6 508.9C352.6 504.6 350.3 496.6 353.3 489.7L391.7 399.1H336C329.3 399.1 323.4 395.9 321 389.6C318.7 383.4 320.4 376.3 325.5 371.1L453.5 259.1C459.1 255 467.4 254.7 473.4 259.1C479.4 263.4 481.6 271.4 478.7 278.3L440.3 367.1zM116.7 219.1L19.85 119.2C-8.112 90.26-6.614 42.31 24.85 15.34C51.82-8.137 93.26-3.642 118.2 21.83L128.2 32.32L137.7 21.83C162.7-3.642 203.6-8.137 231.6 15.34C262.6 42.31 264.1 90.26 236.1 119.2L139.7 219.1C133.2 225.6 122.7 225.6 116.7 219.1H116.7z"/></svg>',
        Et = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M413.8 447.1L256 448l0 31.99C256 497.7 241.8 512 224.1 512c-17.67 0-32.1-14.32-32.1-31.99l0-31.99l-158.9-.0099c-28.5 0-43.69-34.49-24.69-56.4l68.98-79.59H62.22c-25.41 0-39.15-29.8-22.67-49.13l60.41-70.85H89.21c-21.28 0-32.87-22.5-19.28-37.31l134.8-146.5c10.4-11.3 28.22-11.3 38.62-.0033l134.9 146.5c13.62 14.81 2.001 37.31-19.28 37.31h-10.77l60.35 70.86c16.46 19.34 2.716 49.12-22.68 49.12h-15.2l68.98 79.59C458.7 413.7 443.1 447.1 413.8 447.1z"/></svg>',
        xt = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M224 256c70.7 0 128-57.31 128-128S294.7 0 224 0C153.3 0 96 57.31 96 128S153.3 256 224 256zM274.7 304H173.3c-95.73 0-173.3 77.6-173.3 173.3C0 496.5 15.52 512 34.66 512H413.3C432.5 512 448 496.5 448 477.3C448 381.6 370.4 304 274.7 304zM479.1 320h-73.85C451.2 357.7 480 414.1 480 477.3C480 490.1 476.2 501.9 470 512h138C625.7 512 640 497.6 640 479.1C640 391.6 568.4 320 479.1 320zM432 256C493.9 256 544 205.9 544 144S493.9 32 432 32c-25.11 0-48.04 8.555-66.72 22.51C376.8 76.63 384 101.4 384 128c0 35.52-11.93 68.14-31.59 94.71C372.7 243.2 400.8 256 432 256z"/></svg>',
        St = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  <defs>
  ...
  <path fill="url('#radial')" d="M506.3 417l-213.3-364c-16.33-28-57.54-28-73.98 0l-213.2 364C-10.59 444.9 9.849 480 42.74 480h426.6C502.1 480 522.6 445 506.3 417zM232 168c0-13.25 10.75-24 24-24S280 154.8 280 168v128c0 13.25-10.75 24-23.1 24S232 309.3 232 296V168zM256 416c-17.36 0-31.44-14.08-31.44-31.44c0-17.36 14.07-31.44 31.44-31.44s31.44 14.08 31.44 31.44C287.4 401.9 273.4 416 256 416z" />
        ...
        Pt = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M310.6 361.4c12.5 12.5 12.5 32.75 0 45.25C304.4 412.9 296.2 416 288 416s-16.38-3.125-22.62-9.375L160 301.3L54.63 406.6C48.38 412.9 40.19 416 32 416S15.63 412.9 9.375 406.6c-12.5-12.5-12.5-32.75 0-45.25l105.4-105.4L9.375 150.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 210.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-105.4 105.4L310.6 361.4z"/></svg>';

    function zt(i, e) {
        const t = D(e);
        return t.dataset.icon = i, t.classList.add(O("icon")), t
    }
    const Ae = {
            clock: ut,
            flag: pt,
    ...
    function Ie(i, e) {
        if (!(i in Ae)) return console.warn(`Unknown icon: "${i}"`), document.createElement("div");
        const t = zt(i, Ae[i]);
        return e && t.classList.add(O(`icon-${e}`)), t
    }
    const Lt = {
        mode: "sync"
    };
    class g {
        constructor(e, t = {}) {
            ...
            b(this, k, void 0);
            b(this, A, void 0);
            W(this, k, e), W(this, A, t.mode || Lt.mode)
        }
        renderSync(e = {}) {
            const t = D(w(this, k).call(this, e));
            return v(this, R, ye).call(this, t, e), v(this, T, ge).call(this, t), v(this, I, pe).call(this, t, e), t
        }
        async renderAsync(e = {}) {
            const t = D(w(this, k).call(this, e));
            return v(this, R, ye).call(this, t, e), v(this, T, ge).call(this, t), await v(this, I, pe).call(this, t, e), t
        }
        render(e) {
            return w(this, A) === "sync" ? this.renderSync(e) : this.renderAsync(e)
        }
    }
    k = new WeakMap, A = new WeakMap, I = new WeakSet, pe = async function (e, t) {
        const o = e.querySelectorAll("[data-view]"),
            s = [];
        for (const r of o) {
            const a = t[r.dataset.view];
            a ? r.dataset.render !== "sync" ? s.push(a.render().then(c => (r.replaceWith(c), c))) : r.replaceWith(a.renderSync()) : r.remove()
        }
        return Promise.all(s)
    }, T = new WeakSet, ge = function (e) {
        e.querySelectorAll("i[data-icon]").forEach(o => {
            const {
                icon: s,
                size: r
            } = o.dataset;
            o.replaceWith(Ie(s, r))
        })
    }, R = new WeakSet, ye = function (e, t) {
...
`);
    ...
    class Te {
        ...
        doRender(e, t, o) {
            ...
            const {
                content: s,
                resolver: r
            } = this.render(e, o), a = s instanceof Element ? s : s.el;
            return r && r(), a
        }
        doEmit(e) {
        ...
        renderCustom(e, t, o = "") {
            const s = [It.customEmoji, o].join(" ").trim(),
                {
                    content: r,
                    resolver: a
                } = this.renderImage(s, () => e.url),
    ...
    class Re extends Te {
        render(e) {
            return this.renderElement(Tt.renderSync({
                emoji: e.emoji
            }))
        }
        emit({
    ...
    ie.deleteDatabase = i => new Promise((e, t) => {
    ...
    class Rt extends Pe {
        async open() {
            ...
            return new Promise((t, o) => {
                e.addEventListener("success", s => {
                    ...
                    var a;
                    this.db = (a = s.target) == null ? void 0 : a.result, this.db.createObjectStore("category", {
                        keyPath: "order"
                    });
        ...
        async getEtags() {
            const t = this.db.transaction("meta", "readonly").objectStore("meta"),
                [o, s] = await Promise.all([this.waitForRequest(t.get("emojisEtag")), this.waitForRequest(t.get("messagesEtag"))]);
            return {
        ...
        async getCategories(e) {
            ...
            let r = (await this.waitForRequest(o.getAll())).target.result.filter(c => c.key !== "component");
            if (e.showRecents && r.unshift({
                ...
                r = r.filter(h => c.includes(h.key)), r.sort((h, p) => c.indexOf(h.key) - c.indexOf(p.key))
            } else r.sort((c, h) => c.order - h.order);
            return r
        }
        async getEmojis(e, t) {
            const r = this.db.transaction("emoji", "readonly").objectStore("emoji").index("category"),
                h = (await this.waitForRequest(r.getAll(e.order))).target.result.filter(p => p.version <= t).sort((p, m) => p.order != null && m.order != null ? p.order - m.order : 0).map(z);
            return H(h, t)
        }
        async searchEmojis(e, t, o, s) {
            ...
            return new Promise((a, c) => {
                ...
                m.addEventListener("success", d => {
                    var Qe;
                    const de = (Qe = d.target) == null ? void 0 : Qe.result;
                    if (!de) return a([...H(r, o), ...t.filter(Bi => N(Bi, e))]);
                    const me = de.value;
                    N(me, e, s) && me.version <= o && r.push(z(me)), de.continue()
    ...
    class oe {}
    const se = "PicMo:recents";
    class Ve extends oe {
        constructor(e) {
            super(), this.storage = e
        }
        clear() {
            this.storage.removeItem(se)
        }
        getRecents(e) {
            var t;
            try {
                return JSON.parse((t = this.storage.getItem(se)) != null ? t : "[]").slice(0, e)
            } catch {
                return []
            }
        }
        addOrUpdateRecent(e, t) {
            const o = [e, ...this.getRecents(t).filter(s => s.hexcode !== e.hexcode)].slice(0, t);
            try {
                this.storage.setItem(se, JSON.stringify(o))
            } catch {
    ...
    xe() || (console.warn("[picmo] localStorage not available, falling back to simple in-memory storage"), Object.defineProperty(window, "localStorage", {
        value: Se()
    }));
    ...
    class K {
        ...
        on(e, t, o) {
            v(this, M, fe).call(this, e, t, o)
        }
        once(e, t, o) {
            v(this, M, fe).call(this, e, t, o, !0)
        }
        off(e, t) {
            const o = v(this, E, J).call(this, e);
            w(this, C).set(e, o.filter(s => s.handler !== t))
        }
        emit(e, ...t) {
            v(this, E, J).call(this, e).forEach(s => {
    ...
    C = new WeakMap, E = new WeakSet, J = function (e) {
        return w(this, C).has(e) || w(this, C).set(e, []), w(this, C).get(e)
    }, M = new WeakSet, fe = function (e, t, o, s = !1) {
        v(this, E, J).call(this, e).push({
            context: o,
            handler: t,
            once: s
        })
    ...
    class Vt extends K {}
    class Bt extends K {}
    const re = y("emojiCategory", "categoryName", "noRecents", "recentEmojis");
    class ae extends l {
        constructor({
            template: e,
            category: t,
            ...
            super({
                ...
                categoryName: l.byClass(re.categoryName)
...
`),
    ...
    class Nt {
        constructor(e, t, o = 0, s = 0, r = !1) {
            this.events = new K, this.keyHandlers = {
    ...
    class L extends l {
        constructor({
            ...
            super({
                template: Ht,
                classes: Ut
            }), this.fullHeight = !1, this.showVariants = t, this.lazyLoader = s, this.preview = o, this.emojis = e, this.category = r, this.fullHeight = a, this.setFocus = this.setFocus.bind(this), this.triggerNextCategory = this.triggerNextCategory.bind(this), this.triggerPreviousCategory = this.triggerPreviousCategory.bind(this)
        }
        initialize() {
            this.grid = new Nt(this.options.emojisPerRow, this.emojiCount, 0, 0, !this.category), this.grid.on("focus:change", this.setFocus), this.grid.on("focus:overflow", this.triggerNextCategory), this.grid.on("focus:underflow", this.triggerPreviousCategory), this.uiEvents = [l.uiEvent("click", this.selectEmoji), l.uiEvent("keydown", this.grid.handleKeyDown)], this.preview && this.uiEvents.push(l.uiEvent("mouseover", this.showPreview), l.uiEvent("mouseout", this.hidePreview), l.uiEvent("focus", this.showPreview, {
                capture: !0
            ...
            if (!!e)
                if (typeof e == "string") {
                    ...
                    this.grid.setFocusedIndex(o, !1), setTimeout(() => {
                        ...
                        s.scrollIntoView();
                        const r = (c = s.parentElement) == null ? void 0 : c.previousElementSibling,
                            a = (p = (h = s.parentElement) == null ? void 0 : h.parentElement) == null ? void 0 : p.parentElement;
                        a.scrollTop -= (m = r == null ? void 0 : r.offsetHeight) != null ? m : 0
                    })
        ...
        renderSync() {
            return this.emojiViews = this.emojis.map(e => this.viewFactory.create(Ne, {
                emoji: e,
        ...
        hidePreview(e) {
            B(e, this.emojis) && this.events.emit("preview:hide")
        }
        get emojiCount() {
...
`);
    class qt extends ae {
        constructor({
            ...
            super({
                ...
                lazyLoader: o,
                template: Kt
            }), this.showVariants = t, this.lazyLoader = o, this.emojiVersion = s
        }
        initialize() {
            this.uiElements = {
                ...this.baseUIElements
        ...
        async render() {
            ...
            return this.emojiContainer = this.viewFactory.create(L, {
                emojis: e,
                showVariants: this.showVariants,
                lazyLoader: this.lazyLoader,
    ...
    class Gt extends L {
        ...
        async addOrUpdate(e) {
            ...
            const o = this.viewFactory.create(Ne, {
                emoji: e
            });
            if (this.el.insertBefore(o.renderSync(), this.el.firstChild), this.emojis = [e, ...this.emojis.filter(s => s !== e)], this.emojis.length > this.options.maxRecents) {
                this.emojis = this.emojis.slice(0, this.options.maxRecents);
                const s = this.el.childElementCount - this.options.maxRecents;
                for (let r = 0; r < s; r++) this.el.lastElementChild && this.el.removeChild(this.el.lastElementChild)
            }
        }
    }
    const Wt = new g(({
...
`, {
    ...
    class Jt extends ae {
        ...
        initialize() {
            this.uiElements = {
                ...this.baseUIElements,
                recents: l.byClass(re.recentEmojis)
            }, this.appEvents = {
        ...
        async render() {
            ...
            return this.emojiContainer = this.viewFactory.create(Gt, {
                emojis: e,
                showVariants: !1,
                lazyLoader: this.lazyLoader,
                category: this.category.key
    ...
    class ii extends l {
        constructor({
            ...
            super({
                template: Xt,
                classes: Ue
            }), this.selectedCategory = 0, this.scrollListenerState = "active", this.lazyLoader = new He, this.categoryTabs = e, this.categories = t, this.emojiVersion = o, this.handleScroll = Ce(this.handleScroll.bind(this), 100)
        }
        initialize() {
            this.appEvents = {
        ...
        async selectCategory(e, t = {}) {
            ...
            this.emojiCategories[a].setActive(!0, ti(o), o !== "button" && s), r && (this.el.scrollTop = c), this.scrollListenerState = "resume"
        }
...
`),
        Ke = y("error", "iconContainer", "title");
    class ne extends l {
        constructor({
            message: e,
            icon: t = "warning",
            ...
            super({
                template: o,
                classes: Ke
            }), this.message = e, this.icon = t, this.className = s
        }
        renderSync() {
            const e = [Ke.error, this.className].join(" ").trim();
            return super.renderSync({
...
`),
    ...
    class ai extends ne {
        ...
        async onRetry() {
            ...
            const e = await ee(this.options.locale, this.options.dataStore, this.options.messages, this.options.emojiData, this.emojiData);
            this.viewFactory.setEmojiData(e), this.events.emit("data:ready", e)
        }
    }
    const $ = y("preview", "previewEmoji", "previewName", "tagList", "tag"),
        ni = new g(({
            classes: i,
            tag: e
        }) => `
...
`);
    class li extends l {
        ...
        showPreview(e, t) {
            if (_(this.ui.emoji, t), this.ui.name.textContent = e.label, e.tags) {
                this.ui.tagList.style.display = "flex";
                const o = e.tags.map(s => ni.renderSync({
                    tag: s,
                    classes: $
                }));
                _(this.ui.tagList, ...o)
        ...
        hidePreview() {
            P(this.ui.emoji), P(this.ui.name), P(this.ui.tagList)
        }
    }
    const hi = new g(({
            classes: i,
...
`, {
        ...
        F = y("searchContainer", "searchField", "clearButton", "searchAccessory", "clearSearchButton", "notFound");
    class mi extends l {
        constructor({
            categories: e,
            emojiVersion: t
            ...
            super({
                template: di,
                classes: F
            }), this.categories = e.filter(o => o.key !== "recents"), this.emojiVersion = t, this.search = _e(this.search.bind(this), 100)
        }
        initialize() {
            this.uiElements = {
        ...
        async render() {
            return await super.render(), this.searchIcon = Ie("search"), this.notFoundMessage = this.viewFactory.create(ne, {
                message: this.i18n.get("search.notFound"),
                className: F.notFound,
                icon: "sad"
            }), this.notFoundMessage.renderSync(), this.errorMessage = this.viewFactory.create(ne, {
                message: this.i18n.get("search.error")
            }), this.errorMessage.renderSync(), this.clearSearchButton = hi.render({
                classes: F,
                i18n: this.i18n
        ...
        async search() {
            ...
            if (!!this.searchField.value) try {
                ...
                if (this.events.emit("preview:hide"), t.length) {
                    const o = new He;
                    this.resultsContainer = this.viewFactory.create(L, {
                        emojis: t,
                        fullHeight: !0,
                        showVariants: !0,
                        lazyLoader: o
...
`),
        qe = y("variantOverlay", "variantPopup"),
        ce = {
            easing: "ease-in-out",
            duration: 250,
            fill: "both"
    ...
    class pi extends l {
        constructor({
            ...
            super({
                ...
                classes: qe,
                parent: t
            }), this.focusedEmojiIndex = 0, this.focusTrap = new $e, this.animateShow = () => Promise.all([S(this.el, Ge, ce, this.options), S(this.ui.popup, We, ce, this.options)]), this.emoji = e
        }
        initialize() {
            this.uiElements = {
                popup: l.byClass(qe.variantPopup)
        ...
        animateHide() {
            ...
            return Promise.all([S(this.el, Ge, e, this.options), S(this.ui.popup, We, e, this.options)])
        }
        async hide() {
...
`),
        le = y("categoryTab", "categoryTabActive", "categoryButton");
    class yi extends l {
        constructor({
            category: e,
            icon: t
        ...
        initialize() {
            this.uiElements = {
                button: l.byClass(le.categoryButton)
        ...
        setActive(e, t = {}) {
            ...
            this.el.classList.toggle(le.categoryTabActive, e), o && (this.ui.button.tabIndex = e ? 0 : -1, this.ui.button.ariaSelected = e.toString()), e && s && (this.ui.button.focus(), r && this.events.emit("category:select", this.category.key, {
                scroll: "animate",
                focus: "button",
                performFocus: !1
            })), this.isActive = e
...
`),
        vi = y("categoryButtons", "categoryButtonsContainer");
    class wi extends l {
        constructor({
            categories: e
        }) {
        ...
        initialize() {
            ...
            }, this.uiEvents = [l.uiEvent("scroll", this.checkOverflow)], super.initialize()
        }
        checkOverflow() {
        ...
        renderSync() {
            return this.tabViews = this.categories.map(e => this.viewFactory.create(yi, {
                category: e,
                icon: U[e.key]
            })), super.renderSync({
    ...
    function Ci() {
        var e;
        const i = bi.find(t => _i(t.emoji));
        return (e = i == null ? void 0 : i.version) != null ? e : 1
    }

    function _i(i) {
        const e = document.createElement("canvas").getContext("2d");
        if (e) return e.textBaseline = "top", e.font = "32px Arial", e.fillText(i, 0, 0), e.getImageData(16, 16, 1, 1).data[0] !== 0
    }
  ...
  ` : "", c = ({
    ...
    <div class="${d.categoryTabsSkeleton}">
      ${he(r,`<div class="${d.placeholder} ${d.categoryTab}"></div>`)}
    </div>
  ` : "", h = ({
            showHeader: m,
            classes: d
  ...
  ` : "", p = ({
    ...
    <div class="${d.previewSkeleton}">
      ...
      <ul class="${d.tagList}">
        ${he(3,`<li class="${d.placeholder} ${d.tag}"></li>`)}
      </ul>
    </div>
  ` : "";
        return `
    <div class="picmo__picker ${t.skeleton} ${t.picker} ${o} ${s}">
      ...
      <div class="${t.contentSkeleton}">
        ...
        <div class="${t.emojiGrid}">
          ${he(e,`<div class="${t.placeholder} ${t.emoji}"></div>`)}
        </div>
      </div>
      ${p(i)}
    </div>
  `
    ...
    const xi = new g(i => i.isLoaded ? ki(i) : Ei(i)),
        q = y("picker", "skeleton", "placeholder", "searchSkeleton", "searchInput", "categoryTabsSkeleton", "headerSkeleton", "categoryTab", "contentSkeleton", "categoryName", "emojiGrid", "emoji", "previewSkeleton", "previewEmoji", "previewName", "tagList", "tag", "overlay", "content", "fullHeight", "pluginContainer", "header"),
        G = {
    ...
    class Je extends l {
        constructor() {
            super({
                template: xi,
                classes: q
            }), this.pickerReady = !1, this.externalEvents = new Bt, this.updaters = {
                styleProperty: e => t => this.el.style.setProperty(G[e], t.toString()),
                theme: e => {
        ...
        buildChildViews() {
            return this.options.showPreview && (this.preview = this.viewFactory.create(li)), this.options.showSearch && (this.search = this.viewFactory.create(mi, {
                categories: this.categories,
                emojiVersion: this.emojiVersion
            })), this.options.showCategoryTabs && (this.categoryTabs = this.viewFactory.create(wi, {
                categories: this.categories
            })), this.currentView = this.emojiArea = this.viewFactory.create(ii, {
        ...
        setStyleProperties() {
            this.options.showSearch || this.el.style.setProperty("--search-height-full", "0px"), this.options.showCategoryTabs || (this.el.style.setProperty("--category-tabs-height", "0px"), this.el.style.setProperty("--category-tabs-offset", "0px")), this.options.showPreview || this.el.style.setProperty("--emoji-preview-height-full", "0px"), Object.keys(G).forEach(e => {
                this.options[e] && this.el.style.setProperty(G[e], this.options[e].toString())
            })
        }
        updateStyleProperty(e, t) {
            this.el.style.setProperty(G[e], t.toString())
        }
        reinitialize() {
            this.renderSync()
        }
        onError(e) {
            const t = this.viewFactory.create(ai, {
                    message: this.i18n.get("error.load")
                }),
                o = this.el.offsetHeight || 375;
            throw this.el.style.height = `${o}px`, _(this.el, t.renderSync()), e
        }
        async onDataReady(e) {
            const t = this.el;
            try {
                e ? this.emojiData = e : await this.emojiDataPromise, this.options.emojiVersion === "auto" ? this.emojiVersion = Ci() || parseFloat(u) : this.emojiVersion = this.options.emojiVersion, this.categories = await this.emojiData.getCategories(this.options);
        ...
        renderSync() {
            ...
            return _(this.options.rootElement, this.el), this.setStyleProperties(), this.pickerReady && this.initializePickerView(), this.el
        }
        ...
        showContent(e = this.emojiArea) {
            var t, o;
            e !== this.currentView && (this.currentView !== this.emojiArea && ((t = this.currentView) == null || t.destroy()), this.ui.pickerContent.classList.toggle(q.fullHeight, e !== this.emojiArea), _(this.ui.pickerContent, e.el), this.currentView = e, e === this.emojiArea ? (this.emojiArea.reset(), this.categoryTabs && this.ui.header.appendChild(this.categoryTabs.el)) : (o = this.categoryTabs) == null || o.el.remove())
        }
        hideVariantPopup() {
            var e;
        ...
        async showVariantPopup(e) {
            ...
            this.events.once("variantPopup:hide", () => {
                t == null || t.focus()
            }), this.variantPopup = this.viewFactory.create(pi, {
                emoji: e,
                parent: this.el
    ...
    class Si {
        constructor({
            ...
            this.events = e, this.i18n = t, this.renderer = o, this.emojiData = s, this.options = r, this.customEmojis = a, this.pickerId = c
        }
        setEmojiData(e) {
    ...
    class Pi {
        constructor(e = {}) {
            b(this, V, void 0);
            W(this, V, new Map(Object.entries(e)))
        }
        get(e, t = e) {
...
`;
    ...
    function $i(i) {
        return ee(i.locale, i.dataStore, i.messages, i.emojiData)
    }
    let Fi = 0;

    function Ai() {
        return `picmo-${Date.now()}-${Fi++}`
    }
    const Ii = Ye();
    ...
    class Mi extends oe {
        ...
        addOrUpdateRecent(e, t) {
            this.recents = [e, ...this.getRecents(t).filter(o => o.hexcode !== e.hexcode)].slice(0, t)
        }
    }
    async function Vi(i, e, t, o) {
        (await ee(i, e, t, o)).close()
    }
    n.EmojiPicker = Je, n.Events = K, n.FocusTrap = $e, n.InMemoryProvider = Mi, n.InMemoryStoreFactory = Z, n.IndexedDbStoreFactory = ie, n.LocalStorageProvider = Be, n.NativeRenderer = Re, n.RecentsProvider = oe, n.Renderer = Te, n.SessionStorageProvider = Ri, n.animate = S, n.autoTheme = mt, n.caseInsensitiveIncludes = Q, n.computeHash = je, n.createDatabase = Vi, n.createPicker = Ti, n.createStyleInjector = Ye, n.darkTheme = dt, n.debounce = _e, n.deleteDatabase = ht, n.empty = P, n.en = Me, n.getEmojiForEvent = B, n.getOptions = De, n.getPrefixedClasses = y, n.globalConfig = Oe, n.isLocalStorageAvailable = xe, n.isSessionStorageAvailable = Ee, n.lightTheme = Fe, n.prefixClassName = O, n.replaceChildren = _, n.shouldAnimate = Y, n.throttle = Ce, n.toElement = D, Object.defineProperties(n, {
        __esModule: {
            value: !0
        },
        [Symbol.toStringTag]: {
